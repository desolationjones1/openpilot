  ...
  def get_params(candidate, fingerprint=gen_empty_fingerprint(), has_relay=False, car_fw=[]):
    ...
    if candidate == CAR.CIVIC:
      ...
      if eps_modified:
        ...
        ret.lateralParams.torqueBP, ret.lateralParams.torqueV = [[0, 2560, 12000], [0, 2560, 3840]] # Things we know: 4096-3840=256. 0x1680(2.2)= 0x3180. 256(2.2)=563. 0x3180-563=12109
      ...
      if eps_modified:
        ...
        # note: max request allowed is 4096, but request is capped at 3840 in firmware, so modifications result in 2x max
        ret.lateralParams.torqueBP, ret.lateralParams.torqueV = [[0, 2566, 19500], [0, 2566, 3840]] # Things we know: 4096-3840=256. 256(4.5)=1152. 0x5100-1152=19584 
