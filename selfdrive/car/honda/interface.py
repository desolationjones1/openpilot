  ...
  def get_params(candidate, fingerprint=gen_empty_fingerprint(), has_relay=False, car_fw=[]):
    ...
    if candidate == CAR.CIVIC:
      ...
      if eps_modified:
        ...
        ret.lateralParams.torqueBP, ret.lateralParams.torqueV = [[0, 2560, 10880], [0, 2560, 3840]] # average of 0x2880 and 0x3180
      ...
      if eps_modified:
        ...
        # modified request output values: 0x0000, 0x0380, 0x0800, 0x0C00, 0x0EB6, 0x10AE, 0x1200, 0x1B00  0x2D00 (#2x Torque mod)
        ...
        # note: max request allowed is 4096, but request is capped at 3840 in firmware, so modifications result in 2x max
        ret.lateralParams.torqueBP, ret.lateralParams.torqueV = [[0, 2566, 9000], [0, 2566, 3840]]
        ret.lateralTuning.pid.kpV, ret.lateralTuning.pid.kiV = [[0.4], [0.12]] # 2x
      else:
