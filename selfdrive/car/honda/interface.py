  ...
  def get_params(candidate, fingerprint=gen_empty_fingerprint(), has_relay=False, car_fw=[]):
    ...
    if candidate == CAR.CIVIC:
      ...
      if eps_modified:
        ...
        ret.lateralParams.torqueBP, ret.lateralParams.torqueV = [[0, 2560, 21600], [0, 2560, 3840]]
      ...
      if eps_modified:
        ret.lateralTuning.pid.kf = 0.00006 # has modified steering FW
      ...
      if eps_modified:
        ...
        # modified request output values: 0x0000, 0x0380, 0x0800, 0x0C00, 0x0EB6, 0x10AE, 0x1200, 0x2D00, 0x4800 (#4x Torque mod)
