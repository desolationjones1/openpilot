  ...
  def get_params(candidate, fingerprint=gen_empty_fingerprint(), has_relay=False, car_fw=[]):
    ...
    if candidate == CAR.CIVIC:
      ...
      if eps_modified:
        ...
        ret.lateralParams.torqueBP, ret.lateralParams.torqueV = [[0, 2560, 5700, 6000], [0, 2560, 3840, 4096]] # Kirils recommendation 
      ...
      if eps_modified:
        ...
        # note: max request allowed is 4096, but request is capped at 3840 in firmware, so modifications result in 2x max
        ret.lateralParams.torqueBP, ret.lateralParams.torqueV = [[0, 2566, 5700, 6000], [0, 2566, 3840, 4096]] # Things we know: Kirils recommendation 
